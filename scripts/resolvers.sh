...
aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutXTenantSendingNode --data-source-name ${node_datasource} --response-mapping-template file://${templates_path} || aws appsync update-resolver --api-id ${api_id} --type-name Mutation --field-name PutXTenantSendingNode --data-source-name ${node_datasource} --response-mapping-template file://${templates_path}           
...
############# type-name = XTenantReceivingNode ###############

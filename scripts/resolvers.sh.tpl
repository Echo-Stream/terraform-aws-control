...
aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutDicomTcpOutboundNode --data-source-name ${node_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutEdge --data-source-name ${edge_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutExternalApp --data-source-name ${app_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutExternalNode --data-source-name ${node_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutHl7MllpInboundNode --data-source-name ${node_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutHl7MllpOutboundNode --data-source-name ${node_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutKmsKey --data-source-name ${kms_key_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutManagedApp --data-source-name ${app_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutMessageType --data-source-name ${message_type_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutRouterNode --data-source-name ${node_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutTenant --data-source-name ${tenant_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutTransNode --data-source-name ${node_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutXTenantSendingApp --data-source-name ${app_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name PutXTenantSendingNode --data-source-name ${node_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name AddUserToTenant --data-source-name ${tenant_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name DeleteEdge --data-source-name ${edge_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name DeleteApp --data-source-name ${app_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name DeleteMessageType --data-source-name ${message_type_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name Mutation --field-name DeleteNode --data-source-name ${node_datasource}
...
aws appsync create-resolver --api-id ${api_id} --type-name XTenantReceivingApp --field-name tenant --data-source-name ${sub_field_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name XTenantReceivingApp --field-name nodes --data-source-name ${sub_field_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name XTenantReceivingNode --field-name tenant --data-source-name ${sub_field_datasource}
...
aws appsync create-resolver --api-id ${api_id} --type-name XTenantSendingApp --field-name nodes --data-source-name ${sub_field_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name XTenantSendingNode --field-name tenant --data-source-name ${sub_field_datasource}

aws appsync create-resolver --api-id ${api_id} --type-name XTenantSendingNode --field-name receiveEdges --data-source-name ${sub_field_datasource}
